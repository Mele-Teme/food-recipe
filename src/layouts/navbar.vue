  ...
  >
    <div class="h-[50px] flex sm:flex-col lg:flex-row w-full">
      ...
      <ul
        :class="{ show: showNav }"
        ref="classToggle"
        class="nav bg-gray-100 z-0 mx-auto sm:flex lg:flex sm:flex-col lg:flex-row sm:items-center lg:items-end lg:w-3/4 sm:mb-2 lg:my-0 text-slate-700 w-full sm:-translate-y-[100vh] invisible lg:translate-y-[0px] transition-all duration-500 shadow-2xl"
      >
        <li
